                ...
                try {
                    ...
                    const chatCompletion = await groq.chat.completions.create({
                        messages: [
                            {
                                role: "system",
                                content: "Kamu adalah Neural AI, asisten virtual yang ramah dan membantu. Jawab pertanyaan dengan informatif dan friendly dalam bahasa Indonesia. Gunakan format yang bersih dan mudah dibaca tanpa simbol markdown seperti ** atau *. Gunakan format poin dengan angka atau simbol sederhana jika perlu membuat list."
                            },
                            {
                                role: "user",
                                content: message
